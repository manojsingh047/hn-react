    ...
    <li className="news-item">
      ...
      <span className="title">
        {props.story.url && !props.story.url.startsWith("item?id=") ? (
          ...
          <Link to={`/item/${props.story.id}`}><span>{props.story.title}</span></Link>
        )}
      </span>
      <br />
      <span className="meta">
        {props.story.type !== "job" ? (
          <>
            by <Link to={`/users/${props.story.user}`}><span>{props.story.user}</span></Link>{" "}
          ...
          <Link to={`/stories/${props.story.id}`}><span>{props.story.time_ago}</span></Link>
        )}
      </span>
